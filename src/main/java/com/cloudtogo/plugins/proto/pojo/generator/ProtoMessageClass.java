 ...
 */
public class ProtoMessageClass {
    ...
    private List<ProtoMessageField> fieldList;
    ...
    public List<ProtoMessageField> getFieldList() {
        return fieldList;
    }

    public void setFieldList(List<ProtoMessageField> fieldList) {
